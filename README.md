...
Capture ownership is deliberately outside this package: Desktop owns configuration and capture. The plugin owns authentication, local reads, explicit sharing, and cloud consumption only.
