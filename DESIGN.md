...
The shared Lore plugin package is a single bundle for Claude Code and Codex. It
ships one local stdio MCP server, one auth/proxy layer for the Lore cloud, and
one `skills/` tree that both hosts can understand.
